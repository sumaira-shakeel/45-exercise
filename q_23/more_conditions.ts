...
//unequality test ,
console.log("unequality test with string ", ("orange" as string) != "pear");
//test using the lower case function.
console.log("Lower case function test: " , "HELLO".toLowerCase() === "hello");
//equality and unequality test in numbers.
console.log("Equality test with number:" , 56 === 56);
//unequality test.
console.log("Inquality test with number:" , (29 as number) !== 45);
...
let Anarray :string[]=['Apple','Pear','Kiwwi'];
